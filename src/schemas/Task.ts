...
const task = z.object({
    ...
    id: z.coerce.number({ 
        ...
        invalid_type_error: "Id in Task should be a number of a type to coerce to number."
    })
    ...
    listId: z.coerce.number({ 
        ...
        invalid_type_error: "ListId in Task should be a number of a type to coerce to number."
    })
