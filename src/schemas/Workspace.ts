...
const workspace = z.object({
  ...
  id: z.coerce
    .number({
      ...
      invalid_type_error:
        'Id in Workspace should be a number of a type to coerce to number.',
    })
  ...
  userId: z.coerce
    .number({
      ...
      invalid_type_error:
        'UserId in Workspace should be a number of a type to coerce to number.',
    })
    .positive({
      message: "UserId in Workspace should be greater than 0 '> 0'.",
    })
  ...
  priority: z.union(
    [z.literal('high'), z.literal('medium'), z.literal('low')],
    {
      ...
      invalid_type_error:
        "Priority should be one of the following literals 'high' | 'medium' | 'low'",
    }
  ),
  // STATUS
  status: z.union(
